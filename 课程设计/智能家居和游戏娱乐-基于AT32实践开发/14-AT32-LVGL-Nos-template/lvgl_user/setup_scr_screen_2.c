...
void setup_scr_screen_2(lv_ui *ui){
	...
	lv_obj_set_style_bg_color(ui->screen_2, lv_color_make(0xff, 0x00, 0x27), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_opa(ui->screen_2, 134, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes screen_2_btn_5
	ui->screen_2_btn_5 = lv_btn_create(ui->screen_2);
	lv_obj_set_pos(ui->screen_2_btn_5, 422, 235);
	lv_obj_set_size(ui->screen_2_btn_5, 55, 32);
	...
	lv_obj_set_style_bg_color(ui->screen_2_btn_5, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_2_btn_5_label, "back");
	...
	lv_obj_set_pos(ui->screen_2_img_1, 52, 86);
	lv_obj_set_size(ui->screen_2_img_1, 100, 100);
	lv_obj_set_scrollbar_mode(ui->screen_2_img_1, LV_SCROLLBAR_MODE_OFF);

	//Set style for screen_2_img_1. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_img_recolor(ui->screen_2_img_1, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->screen_2_img_1,&_11_alpha_100x100);
	...
	lv_obj_set_pos(ui->screen_2_img_2, 190, 86);
	lv_obj_set_size(ui->screen_2_img_2, 100, 100);
	lv_obj_set_scrollbar_mode(ui->screen_2_img_2, LV_SCROLLBAR_MODE_OFF);

	//Set style for screen_2_img_2. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_img_recolor(ui->screen_2_img_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->screen_2_img_2,&_22_alpha_100x100);
	...
	lv_obj_set_pos(ui->screen_2_img_3, 305, 86);
	lv_obj_set_size(ui->screen_2_img_3, 100, 100);
	lv_obj_set_scrollbar_mode(ui->screen_2_img_3, LV_SCROLLBAR_MODE_OFF);

	//Set style for screen_2_img_3. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_img_recolor(ui->screen_2_img_3, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->screen_2_img_3,&_33_alpha_100x100);
	...
	lv_obj_set_pos(ui->screen_2_label_3, 4, 194);
	lv_obj_set_size(ui->screen_2_label_3, 96, 26);
	lv_obj_set_scrollbar_mode(ui->screen_2_label_3, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_2_label_3, "当前温度：");
	...
	lv_obj_set_style_bg_color(ui->screen_2_label_3, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_2_label_3, &myFont, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes screen_2_label_4
	ui->screen_2_label_4 = lv_label_create(ui->screen_2);
	lv_obj_set_pos(ui->screen_2_label_4, 65, 194);
	lv_obj_set_size(ui->screen_2_label_4, 94, 26);
	lv_obj_set_scrollbar_mode(ui->screen_2_label_4, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_2_label_4, "26°");
	...
	lv_obj_set_style_bg_color(ui->screen_2_label_4, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_2_sw_1, 214, 200);
	lv_obj_set_size(ui->screen_2_sw_1, 40, 20);
	lv_obj_set_scrollbar_mode(ui->screen_2_sw_1, LV_SCROLLBAR_MODE_OFF);

	//Set style for screen_2_sw_1. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_radius(ui->screen_2_sw_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_2_sw_1, lv_color_make(0xe6, 0xe2, 0xe6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_2_sw_1, lv_color_make(0xe6, 0xe2, 0xe6), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_shadow_color(ui->screen_2_sw_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->screen_2_sw_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_spread(ui->screen_2_sw_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_x(ui->screen_2_sw_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_y(ui->screen_2_sw_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->screen_2_sw_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_2_sw_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->screen_2_sw_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Set style for screen_2_sw_1. Part: LV_PART_INDICATOR, State: LV_STATE_CHECKED
	lv_obj_set_style_bg_color(ui->screen_2_sw_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_bg_grad_color(ui->screen_2_sw_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	...
	lv_obj_set_style_border_color(ui->screen_2_sw_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_border_width(ui->screen_2_sw_1, 0, LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_border_opa(ui->screen_2_sw_1, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);

	//Set style for screen_2_sw_1. Part: LV_PART_KNOB, State: LV_STATE_DEFAULT
	lv_obj_set_style_radius(ui->screen_2_sw_1, 100, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_2_sw_1, lv_color_make(0xff, 0xff, 0xff), LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_2_sw_1, lv_color_make(0xff, 0xff, 0xff), LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_border_color(ui->screen_2_sw_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_2_sw_1, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->screen_2_sw_1, 255, LV_PART_KNOB|LV_STATE_DEFAULT);

	//Write codes screen_2_sw_2
	ui->screen_2_sw_2 = lv_switch_create(ui->screen_2);
	lv_obj_set_pos(ui->screen_2_sw_2, 335, 200);
	lv_obj_set_size(ui->screen_2_sw_2, 40, 20);
	lv_obj_set_scrollbar_mode(ui->screen_2_sw_2, LV_SCROLLBAR_MODE_OFF);

	//Set style for screen_2_sw_2. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_radius(ui->screen_2_sw_2, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_2_sw_2, lv_color_make(0xe6, 0xe2, 0xe6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_2_sw_2, lv_color_make(0xe6, 0xe2, 0xe6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_2_sw_2, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->screen_2_sw_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_2_sw_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(ui->screen_2_sw_2, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->screen_2_sw_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_spread(ui->screen_2_sw_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_x(ui->screen_2_sw_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_y(ui->screen_2_sw_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->screen_2_sw_2, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_2_sw_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->screen_2_sw_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Set style for screen_2_sw_2. Part: LV_PART_INDICATOR, State: LV_STATE_CHECKED
	lv_obj_set_style_bg_color(ui->screen_2_sw_2, lv_color_make(0x21, 0x95, 0xf6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_bg_grad_color(ui->screen_2_sw_2, lv_color_make(0x21, 0x95, 0xf6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_bg_grad_dir(ui->screen_2_sw_2, LV_GRAD_DIR_NONE, LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_bg_opa(ui->screen_2_sw_2, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_border_color(ui->screen_2_sw_2, lv_color_make(0x21, 0x95, 0xf6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_border_width(ui->screen_2_sw_2, 0, LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_border_opa(ui->screen_2_sw_2, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);

	//Set style for screen_2_sw_2. Part: LV_PART_KNOB, State: LV_STATE_DEFAULT
	lv_obj_set_style_radius(ui->screen_2_sw_2, 100, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_2_sw_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_2_sw_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_2_sw_2, LV_GRAD_DIR_NONE, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->screen_2_sw_2, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->screen_2_sw_2, lv_color_make(0x21, 0x95, 0xf6), LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_2_sw_2, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->screen_2_sw_2, 255, LV_PART_KNOB|LV_STATE_DEFAULT);

	//Write codes screen_2_label_5
	ui->screen_2_label_5 = lv_label_create(ui->screen_2);
	lv_obj_set_pos(ui->screen_2_label_5, 0, 220);
	lv_obj_set_size(ui->screen_2_label_5, 100, 32);
	lv_obj_set_scrollbar_mode(ui->screen_2_label_5, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_2_label_5, "AD");
	...
	lv_obj_set_style_bg_color(ui->screen_2_label_5, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_2_label_6, 65, 220);
	lv_obj_set_size(ui->screen_2_label_6, 100, 32);
	lv_obj_set_scrollbar_mode(ui->screen_2_label_6, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_2_label_6, "2600");
	lv_label_set_long_mode(ui->screen_2_label_6, LV_LABEL_LONG_WRAP);

	//Set style for screen_2_label_6. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_radius(ui->screen_2_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_2_label_6, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_2_label_6, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_2_label_6, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_shadow_color(ui->screen_2_label_6, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->screen_2_label_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_spread(ui->screen_2_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_x(ui->screen_2_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_y(ui->screen_2_label_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_2_label_6, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_pad_top(ui->screen_2_label_6, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
